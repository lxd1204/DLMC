...
function members = FastMICE_EnsembleGeneration_privacy(fea, M, p, Knn, lowK, upK,lowerFeatureRatio, upperFeatureRatio,distance)
...
%**************************************************************************
% each base only use a single view
%
%
%**************************************************************************
